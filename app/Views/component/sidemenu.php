<div class="main-sidebar main-sidebar-sticky side-menu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?php echo base_url('Main')?>"><i class="fe fe-airplay"></i><span class="sidemenu-label">Dashboard</span></a>
						</li>
						<li class="nav-label">Applications</li>
						<li class="nav-item">
							<a class="nav-link" href="#0"><i class="fe fe-database"></i><span class="sidemenu-label">Widgets</span></a>
						</li>
						<!-- <li class="nav-item">
