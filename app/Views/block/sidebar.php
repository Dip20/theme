				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item  show">
							<a class="nav-link" href="#0"><i class="fe fe-airplay"></i><span class="sidemenu-label">Dashboard</span></a>
						</li>
						<li class="nav-label">Master</li>

						<li class="nav-item  show">
							<a class="nav-link" href="<?=url('Home/addaccount')?>"><i class="fe fe-airplay"></i><span class="sidemenu-label">Add Account</span></a>
						</li>
						<li class="nav-item  show">
							<a class="nav-link" href="<?=url('Home/additem')?>"><i class="fe fe-airplay"></i><span class="sidemenu-label">Add Item</span></a>
						</li>
						<li class="nav-item  show">
							<a class="nav-link" href="<?=url('Home/uom')?>"><i class="fe fe-airplay"></i><span class="sidemenu-label">UOM</span></a>
						</li>
						<li class="nav-item  show">
							<a class="nav-link" href="<?=url('Home/add_uom')?>"><i class="fe fe-airplay"></i><span class="sidemenu-label">ADD UOM</span></a>
						</li>
						<li class="nav-item  show">
							<a class="nav-link" href="<?=url('Home/add_sales_invoice')?>"><i class="fe fe-airplay"></i><span class="sidemenu-label">Add Sales Invoice</span></a>
						</li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="darggablecards.html">Darggable-Cards</a>
								</li>
								<li class="nav-sub-item">
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="products.html">Products</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="product-details.html">Product-Details</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="product-cart.html">Cart</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
